# ==============================================================================
# FILE: final_app.py (PHIÊN BẢN CUỐI CÙNG - TÁI CẤU TRÚC BỐ CỤC)
# ==============================================================================
...
API_KEY = "0a291052e260f6fadaa6519a3aaa7ccd" # <-- Thay key của bạn nếu cần
...
# PHẦN 3: LOGIC GIAO DIỆN (ĐÃ TÁI CẤU TRÚC)
...
root.geometry("450x580") # <-- Tăng chiều cao một chút
...
# KHUNG 4: NÚT BẤM VÀ TRẠNG THÁI
action_frame = tk.Frame(root, bg=BG_COLOR)
action_frame.pack(fill=tk.X, padx=20, pady=10)
search_button = tk.Button(action_frame, text="Xem Thời Tiết", font=DEFAULT_FONT, bg=BUTTON_COLOR, fg=BUTTON_TEXT, relief=tk.FLAT, activebackground="#357ABD", activeforeground=BUTTON_TEXT)
search_button.pack()
